...
export declare class AbcOrderRecordDAO {
    ...
    createOrderRecord(subjectId: number, orderId: number, orderCode: string, transactionNo: string, abcTranNo: string, abcMeta: string, payStatus: AbcPayStatus, company: number, supplierId: number, amount: number, creator: number, entityManager: EntityManager, context: Context): Promise<AbcOrderRecord>;
