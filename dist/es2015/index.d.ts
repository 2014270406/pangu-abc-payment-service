...
export declare class AbcPaymentServices {
    ...
    initialize(masterConnection: Connection, replicationConnection: Connection, abcAccountRecordUpdateHook: Consumer<number[]> | undefined, abcOrderRecordUpdateHook: Consumer<number[]> | undefined): Promise<void>;
