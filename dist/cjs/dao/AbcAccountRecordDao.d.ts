...
export declare class AbcAccountRecordDAO {
    ...
    createAccountRecord(subjectId: number, dealerId: string, name: string, code: string, mobile: string, detailJson: string, creator: number, entityManager: EntityManager, context: Context): Promise<AbcAccountRecord>;
    updateAccountRecordById(subjectId: number | undefined, id: number, dealerId: string | undefined, name: string | undefined, code: string | undefined, mobile: string | undefined, detailJson: string | undefined, updater: number, entityManager: EntityManager, context: Context): Promise<void>;
