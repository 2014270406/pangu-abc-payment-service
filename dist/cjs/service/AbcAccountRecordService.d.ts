...
export declare class AbcAccountRecordService {
    ...
    createAccountRecord(subjectId: number, dealerId: number, name: string, code: string, mobile: string, detailJson: string, creator: number, context: Context): Promise<AbcAccountRecord>;
    updateAccountRecordById(subjectId: number | undefined, id: number, dealerId: number | undefined, name: string | undefined, code: string | undefined, mobile: string | undefined, detailJson: string | undefined, updater: number, context: Context): Promise<void>;
